...
function main() {
  try {
    ...
    // Write as TypeScript module so Nuxt/Vite will bundle it properly
    const tsOutput = `/**
...
export const changelog: ChangelogData = ${JSON.stringify(changelog, null, 2)};

export default changelog;
`;
    const outputPath = join(__dirname, "..", "utils", "changelog.ts");
...
export const changelog: ChangelogData = ${JSON.stringify(emptyChangelog, null, 2)};
