<template>
  <div class="h-screen">
    <NuxtPage />
    <footer
      class="fixed bottom-0 left-0 right-0 py-2 px-4 text-xs text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-800 bg-background/95 backdrop-blur-sm z-30"
    >
